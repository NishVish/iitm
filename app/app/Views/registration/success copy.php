...
<body>
    ...
    <div class="cut-wrapper">
        ...
        <!-- Top Left -->
<span style="position:absolute; top:0; left:0; width:12px; height:1px; border-top: 1px solid #999;"></span>
<span style="position:absolute; top:0; left:0; width:1px; height:12px; border-left: 1px solid #999;"></span>
<!-- Top Right -->
<span style="position:absolute; top:0; right:0; width:12px; height:1px; border-top: 1px solid #999;"></span>
<span style="position:absolute; top:0; right:0; width:1px; height:12px; border-right: 1px solid #999;"></span>
<!-- Bottom Left -->
<span style="position:absolute; bottom:0; left:0; width:12px; height:1px; border-bottom: 1px solid #999;"></span>
<span style="position:absolute; bottom:0; left:0; width:1px; height:12px; border-left: 1px solid #999;"></span>
<!-- Bottom Right -->
<span style="position:absolute; bottom:0; right:0; width:12px; height:1px; border-bottom: 1px solid #999;"></span>
<span style="position:absolute; bottom:0; right:0; width:1px; height:12px; border-right: 1px solid #999;"></span>
        <div class="badge" id="badge">

            <div class="badge-header">
                <img src="https://iitmindia.com/wp-content/uploads/2024/03/image-1.png" alt="Logo" class="logo-white">
                <span class="category-tag"><?= $type === 'spot' ? 'DELEGATE' : 'VISITOR' ?></span>
            </div>
