make flask of this<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
.chart {
    ...
    height: 350px; /* Adjusted height to accommodate YoY indicators */
    margin-top: 15px;
    background: #ffffff;
    border: 2px solid #cccccc;
    border-radius: 8px;
    padding: 45px 10px 10px 10px; /* Room for stacked labels above bars */
...
/* 2005 Web 2.0 Glossy Gradient Style */
.trade {
    background: linear-gradient(180deg, 
        ...
        #AA2324 50%, 
        #881213 100%);
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.6), 2px 2px 5px rgba(0,0,0,0.2);
}
...
.exhibitor {
    background: linear-gradient(180deg, 
        ...
        #d65b5d 50%, 
        #a8383a 100%);
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.8), 2px 2px 5px rgba(0,0,0,0.15);
}
    ...
    <div class="card">
        ...
        <div class="chart">
            ...
            <div class="year">
                <div class="bars">
                    <div class="bar-box">
                        <div class="bar trade" style="height:100px;">
            ...
            <div class="year">
                <div class="bars">
                    <div class="bar-box">
                        <div class="bar trade" style="height:150px;">
                            <div class="bar-header">
                                <span class="yoy-badge">+54.5% YoY</span>
                    ...
                    <div class="bar-box">
                        <div class="bar exhibitor" style="height:40px;">
                            <div class="bar-header">
                ...
                <div class="bars">
                    <div class="bar-box">
                        <div class="bar trade" style="height:200px;">
                            <div class="bar-header">
                                <span class="yoy-badge">+34.1% YoY</span>
                    ...
                    <div class="bar-box">
                        <div class="bar exhibitor" style="height:45px;">
                            <div class="bar-header">
        ...
        <div class="stats">
            <div class="stat-card">
                ...
                <div class="row">
                    ...
                    <span class="growth">▲ +54.5% YoY</span>
                </div>
                <div class="row">
                    <span>2026 vs 2025</span>
                    <span class="growth">▲ +34.1% YoY</span>
                </div>
            </div>
        ...
        <div class="insight-box">
            ...
            <p>
                <strong>Accelerated YoY Visitor Expansion:</strong> Trade visitor attendance surged with double-digit YoY growth rates (+54.5% in 2025, +34.1% in 2026), outstripping steady ~5% annual exhibitor growth.
            </p>
            <p style="margin-top: 6px;">
                <strong>YoY ROI Improvement:</strong> The attendee-to-exhibitor density improved YoY from 8.8:1 (2024) to 13.0:1 (2025) and reached 16.5:1 (2026).
            </p>
        </div>
