...
<body>
    ...
    <h2 style="text-align:center; margin-bottom:10px;">
        Step 1: Instructions to Participate as an Exhibitor in IITM
    </h2>
    ...
    <div class="card full-width">
        <p>
            By clicking <strong>“Proceed to Step 2”</strong>, you confirm that you have read and understood the
            instructions
            and agree to continue with the exhibitor registration process.
        </p>

        <div style="text-align: right; padding-right: 10px;">
            <a href="booking/company.html" class="btn-next">Proceed to Step 2</a>
        </div>
    </div>
