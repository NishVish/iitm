...
text/x-generic register.php ( PHP script, UTF-8 Unicode text, with very long lines )
<?php
...
$pdf->Code39(300, 200, $s, '', '', 0.6, 20, 'C');
$pdf->Image($qr, 320, 240, 65, 65, 'PNG');
$pdf->SetY(-800);
$path = getcwd();
$file = "$path/$phone.pdf";
$pdf->Output($file, "F");
...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <title>India International Travel Mart  | Ahmedabad | 20 and 21 March 2025 |Confirmation of Registration
  </title>
...
<table width="800"
 ...
 style="background-color: rgb(225, 225, 223); width: 800px; text-align: left;  margin-left: auto; margin-right: auto;">
  ...
  <tr>
    ...
    <tr>
      ...
      <h3><u>India International Travel Mart  | Ahmedabad | 20 and 21 March 2026 | Confirmation of Registration</u>
      </h3>
      </td>
    </tr>
 ...
 <p> Dear $title $select2 $name,</p>
   ...
   <p>We are delighted to inform you that your registration for the IITM Ahmedbad event has been successfully received.
This email serves as an official confirmation of your participation in the event, which will take place from 20 and 21 March 2026.
<br />
<br />
...
<br />
<br />
We look forward to welcoming you at the IITM Ahmedbad event.
<br />

<p>
Please note: It is a B2B-only Travel & Tourism Exhibition.
</p>

<br />
Should you have any further questions or require any additional information, please feel free to reach out to us.
</P>


   <p>Please keep this mail safe for the future reference regarding your registration, Your reference number id <strong> $visiterid & Your Reference QRCode is </strong> </p>
   <img src="https://iitmindia.com/reg/iitm_ahmedabad/$qr">
   <br /><br />

	Thank you for your participation, and we wish you a successful and enriching experience at the IITM Ahmedabad event.
	 <br />
...
try {
  $mail->SetFrom('info@iitmindia.com', 'India International Travel Mart  | Bangalore | 26 - 28 JULY 2024');
  $mail->AddAddress($email, $email);


 $mail->AddBCC('admin@iitmindia.com', 'CC Recipient 3'); // CC recipient 3

  $mail->Subject = 'Confirmation Mail | India International Travel Mart  | Bangalore | 24 - 26 JULY 2025';
...
*/
/*
$path = "https://iitmindia.com/reg/iitm_bangalore/";
$filename = "$phone.pdf";
$file = $path . $filename;
...
$subject = "Registration Confirmation Mail | India International Travel Mart | Bengaluru | 26 - 28 JULY 2024";
$message = "<b>$html2</b>";
$header = "From: harish@iitmindia.com\r\n";
...
$path = "https://iitmindia.com/reg/iitm_Ahmedabad/";
$filename = "$phone.pdf";
$file = $path . $filename;
$content = file_get_contents($file);
$uid = md5(uniqid(time()));
$file_name = basename($file);
$to = "$email, harish@iitmindia.com,";
$subject = "Registration Confirmation Mail | India International Travel Mart | Ahmedabad | 20 and 21 March 2026";
$message = "<b>$html2</b>";
...
/*
  ...
  $to = "$email";
         $subject = "Confirmation Mail | India International Travel Mart  | Bangalore | 26,27, 28 JULY 2024";
         
         $message = "<b>$html2</b>";
         $message .= "<h1>This is headline.</h1>";
         
         $header = "From:info@iitmindia.com \r\n";
         $header .= "Cc:info@iitmindia.com \r\n";
         $header .= "MIME-Version: 1.0\r\n";
...
$file_to_attach = 'reg/iitm_Bangalore';
...
<head>
  ...
  <title>India International Travel Mart | Ahmedabad | 20 and 21 March 2026 Confirmation</title>
  <!-- Meta Pixel Code -->
<script>
  ...
  <div class="container register">
    <div class="row">
        <div class="col-md-4 col-sm-12 register-left">
            ...
            <h3 style="color: #a42627;"><strong>Registration Confirmation Mail | India International Travel Mart | Ahmedabad | 20 and 21 March 2026</strong></h3>
        </div>
        <div class="col-md-8 col-sm-12 register-right">
          <table class="table table-responsive">
            <tbody>
              <tr>
                <td>
                  <p><strong>Dear <?php echo ucwords($title); ?> <?php echo ucwords($select2); ?> <?php echo ucwords($name); ?>,</strong></p>
                  <p>We are delighted to inform you that your registration for the IITM Ahmedabad event has been successfully confirmed.</p>
                  <p>This message serves as an official confirmation of your participation in the event, which will take place from 20 and 21 March 2026</p>
                 
                  <p>Please find attached your event badge. Kindly print and wear it during the event.</p>
                  
                  <p>Please note: It is a B2B-only Travel & Tourism Exhibition.</p>
                  
                   <p> Should you have any urgent questions or require immediate assistance, please feel free to contact us directly mail to <strong>info@iitmindia.com</strong> or Call:<strong> +91-80-40834100. <strong></p>
