...
<div class="form-group">
    <input type="text" name="pincode" id="pincode" placeholder="Pincode"
        value="<?php echo isset($company['pincode']) ? htmlspecialchars($company['pincode']) : '560071'; ?>"
        class="form-control">
</div>
...
<div class="form-group">
    <input type="hidden" class="form-control" placeholder="city_name *" value="hello" name="city_name" minlength="10"
        maxlength="10">
</div>
