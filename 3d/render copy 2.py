...
# 🔥 IMPORTANT: reduce multiplier
base_radius = radius * 1 # try 1.2 – 2.0
height = base_radius * 0.3
# =========================================================
# SCENE SETUP
# =========================================================
...
# =========================================================
# FORCE LIGHT (DEBUG SAFETY)
# =========================================================
if "AutoLight" not in bpy.data.objects:
    light_data = bpy.data.lights.new(name="AutoLight", type='POINT')
    light = bpy.data.objects.new(name="AutoLight", object_data=light_data)
    bpy.context.collection.objects.link(light)

    light.location = center + Vector((0, 0, size * 2))
...
for i in range(1, frames + 1):
    ...
    # smooth front-left → front → front-right motion
    ...
    r = base_radius + math.sin(t * math.pi) * (base_radius * 0.12)   
    x = center.x + r * math.cos(angle)

    y = center.y + r * math.sin(angle)

    # 👇 FIX: keep camera LOWER, not above scene
    z = center.z + height
