...
use App\Http\Controllers\Backend\DatabaseController as BackendDatabaseControllerApp;
...
Route::get('/getDatabaseSchema', [BackendDatabaseControllerApp::class, 'getDatabaseSchema']);
Route::POST('/runQuery', [BackendDatabaseControllerApp::class, 'runQuery']);
Route::get('/categorized-routes', [BackendDatabaseControllerApp::class, 'categorizedRoutes']);
...
Route::get('/backend/table', [BackendHomeController::class, 'table']);
Route::get('/backend/sql', [BackendHomeController::class, 'sql']);
Route::get('/backend/operation', [BackendHomeController::class, 'operation']);
