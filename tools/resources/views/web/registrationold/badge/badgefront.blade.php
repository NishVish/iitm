  ...
  <div class="frontpage">
    ...
    <div class="badge-section">
      ...
      <div style="display: flex; flex-direction: column; gap: 2.5vh; align-items: center; width: 100%;">
        ...
        @include('web.registrationold.badge.badgecomponent.details')

        @include('web.registrationold.badge.badgecomponent.qr')

        @include('web.registrationold.badge.badgecomponent.eventinfo')
