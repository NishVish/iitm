{{-- resources/views/mobile/events/calendar.blade.php --}}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // URLs updated for Laravel
    const eventsApiUrl = "{{ url('/eventlist') }}";
    const bookUrlBase = "{{ url('stalls/book') }}";
    const layoutUrlBase = "{{ url('layout') }}";
            ...
            data.forEach(event => {
                ...
                <div class="cal-card">
                    ...
                    <div class="cal-actions">
                        <a href="${bookUrlBase}/${event.event_id}" class="cal-btn-book">
                            <i class="fa-solid fa-ticket"></i> Book Stall
                        </a>
                        <a href="${layoutUrlBase}?id=${event.event_id}" class="cal-btn-circle" title="View Details">
