...
<head>
    ...
    <title>India International Travel Mart | Chennai | 16 - 18 July 2025</title>
                ...
                <form action="register.php" method="post" class="register-form">
                    ...
                    <div class="form-group">
                     ...
                     <p>Interested In:</p>
                            ...
                            <br>
                                <input type="checkbox" id="bengaluru" name="bengaluru" value="True"><label for="bengaluru">BENGALURU</label>
                                <br>
                                ...
                                <input type="checkbox" id="hyderabad" name="hyderabad" value="True"><label for="hyderabad">HYDERABAD</label><br>
                                
                                 <input type="checkbox" id="kochi" name="kochi" value="True"><label for="kochi">KOCHI</label> <br>     
                                <input type="checkbox" id="kolkata" name="kolkata" value="True"><label for="kolkata">KOLKATA</label>  <br>
                                <input type="checkbox" id="ahmedabad" name="ahmedabad" value="True"><label for="ahmedabad">AHMEDABAD</label><br><br>
