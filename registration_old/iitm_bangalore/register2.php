...
include('../formvalidation/connection.php');


require('code39.php');
require('class.phpmailer-lite.php');
include('../formvalidation/insert.php');
...
$pdf->Code39(300, 145, $s, '', '', 0.6, 20, 'C');
$pdf->Image($qr, 320, 185, 65, 65, 'PNG');
$pdf->SetY(-800);
$path = getcwd();
$file = "$path/$phone.pdf";
$pdf->Output($file, "F");
...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <title>India International Travel Mart  | Bengaluru | 24 - 26 JULY 2025 |Confirmation of Registration
  </title>
...
<table width="800"
 ...
 style="background-color: rgb(225, 225, 223); width: 800px; text-align: left;  margin-left: auto; margin-right: auto;">
  ...
  <tr>
    ...
    <tr>
      ...
      <h3><u>India International Travel Mart  | Bengaluru | 23 - 25 JULY 2026 | Confirmation of Registration</u>
      </h3>
      </td>
    </tr>
 ...
 <p> Dear $title $select2 $name,</p>
   ...
   <p>We are delighted to inform you that your registration for the IITM Bengaluru event has been successfully received.
This email serves as an official confirmation of your participation in the event, which will take place from 23 - 25 JULY 2026.
<br />
<br />
...
<br />
<br />
We look forward to welcoming you at the IITM Bengaluru event.
<br />

<p> <strong> Please Note It's Only for B2B </strong></p>
...
Should you have any further questions or require any additional information, please feel free to reach out to us.
   ...
   <img src="https://iitmindia.com/reg/iitm_bangalore/$qr">
   <br /><br />

	Thank you for your participation, and we wish you a successful and enriching experience at the IITM Bengaluru event.
	 <br />
...
$file_name = basename($file);
$to = "$email, harish@iitmindia.com,";
$subject = "Registration Confirmation Mail | India International Travel Mart | Bengaluru | 23 - 25 JULY 2026";
$message = "<b>$html2</b>";
...
<head>
  ...
  <title>India International Travel Mart | Bengaluru | 23 - 25 JULY 2026 Confirmation</title>
  <!-- Meta Pixel Code -->
  <script>
  ...
  <div class="container register">
    <div class="row">
      <div class="col-md-4 col-sm-12 register-left">
        <img src="https://iitmindia.com/reg/iitm_delhi/logo.jpg" alt="IITM Logo" />
        <h3 style="color: #a42627;"><strong>Registration Confirmation Mail | India International Travel Mart | Bengaluru
            | 23 - 25 JULY 2026</strong></h3>
      </div>
          ...
          <tbody>
            <tr>
              <td>
                ...
                <p>We are delighted to inform you that your registration for the IITM Bengaluru event has been
