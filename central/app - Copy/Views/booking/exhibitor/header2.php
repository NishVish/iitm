...
<div class="right-container" style="
    position: relative;
    background-image: url('https://iitmindia.com/wp-content/uploads/2025/11/WhatsApp-Image-2025-11-12-at-3.18.08-PM-1400x1536.jpeg');
...
">
    <div style="position: relative; z-index: 1;">
        <!-- Any content like text or buttons goes here -->
        <h2>Right Container Content</h2>
        <p>This is where your text or other elements go.</p>
