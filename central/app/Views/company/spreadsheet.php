...
<head>
    ...
    align-items: flex-end;
        ...
        .custom-table td {
            ...
            max-height: 50px;
            /* ← ADD THIS - prevents expansion */
            line-height: 50px;
            white-space: nowrap;
            overflow: hidden;
            /* Already have this - keeps it clipped */
        ...
        .custom-table td a {
            ...
            vertical-align: middle;
            line-height: normal;
            /* Prevents anchor from expanding 50px cell */
        }
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php for ($i = 1; $i <= ($maxContacts ?? 1); $i++):
                                ...
                                <th>Mobile <?= $startIdx + 3 ?></th>
                                <th>Email <?= $startIdx + 1 ?></th>
                        ...
                        <?php if (isset($companies) && !empty($companies)): ?>
                            <?php foreach ($companies as $comp):
                                ...
                                <tr>
                                    ...
                                    <td><?= esc($d['company_id'] ?? 'N/A') ?></td>
                                    <td><?= esc($d['entry_type'] ?? 'N/A') ?></td>
                                    ...
                                    <td>
                                        <a
                                            href="<?= base_url("company/details/" . ($filters['entry_type'] ?? 'general') . "/" . $d['company_id']) ?>">
