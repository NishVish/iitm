...
// OR var_dump for more detailed info
...
if ($segment == 'profile'):
    ...
    // Include the view that contains the HTML and JS for fetching JSON
    include(APPPATH . 'Views/profile/index.php');
...
<?php include(APPPATH . 'Views/mobilefooter.php'); ?>
