<form id="companyFormEx" action="<?= site_url('company/add_details') ?>" method="post">
    <?= csrf_field() ?>
...
<div class="field-group">
    ...
    <input type="text" name="companies[0][database_name]" value="">
</div>

<div class="field-group">
    <label>Category</label>
    <input type="text" name="companies[0][category]" value="">
</div>

<div class="field-group">
    <label>Source</label>
    <input type="text" name="companies[0][source]" value="">
</div>

<div class="field-group">
    <label>Updated By</label>
    <input type="text" name="companies[0][updated_by]" value="">
</div>

<div class="field-group">
    <label>Updated At</label>
    <input type="datetime-local" name="companies[0][updated_at]" value="">
</div>
...
<div class="field-group">
    <label>Size</label>
    <input type="text" name="companies[0][size]">
</div>

<div class="field-group">
    <label>Price</label>
    <input type="number" step="0.01" name="companies[0][price]">
</div>

<div class="field-group">
    <label>GST Amount</label>
    <input type="number" step="0.01" name="companies[0][gst_amount]">
</div>

<div class="field-group">
    <label>Discount Amount</label>
    <input type="number" step="0.01" name="companies[0][discount_amount]">
</div>

<div class="field-group">
    <label>Grand Total</label>
    <input type="number" step="0.01" name="companies[0][grand_total]">
</div>
