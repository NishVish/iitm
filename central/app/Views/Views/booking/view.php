...
<!-- View file: app/Views/booking_form.php -->

<h2>View Exhibitor Booking</h2>

<form action="<?= site_url('booking/view') ?>" method="post">
    <?= csrf_field() ?>

    <label for="booking_id">Enter Booking ID:</label><br>
    <input type="text" name="booking_id" id="booking_id" placeholder="Booking ID" required>
    <br><br>
