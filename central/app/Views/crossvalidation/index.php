...
<td>company_id</td>
<td><?=$match['company_id']?></td>
<td><?=$match['matched_company_id']?></td>
</tr>
<tr>
<td>company_name</td>
<td><?=$match['original_company_name']?></td>
<td><?=$match['matched_company_name']?></td>
</tr>
<tr>
<td>database_name</td>
<td><?=$match['original_database_name']?></td>
<td><?=$match['matched_database_name']?></td>
</tr>
<tr>
<td>category</td>
<td><?=$match['original_category']?></td>
<td><?=$match['matched_category']?></td>
</tr>
<tr>
<td>address</td>
<td><?=$match['original_address']?></td>
<td><?=$match['matched_address']?></td>
</tr>
<tr>
<td>city</td>
<td><?=$match['original_city']?></td>
<td><?=$match['matched_city']?></td>
</tr>
<tr>
<td>pincode</td>
<td><?=$match['original_pincode']?></td>
<td><?=$match['matched_pincode']?></td>
</tr>
<tr>
<td>state</td>
<td><?=$match['original_state']?></td>
<td><?=$match['matched_state']?></td>
</tr>
<tr>
<td>country</td>
<td><?=$match['original_country']?></td>
<td><?=$match['matched_country']?></td>
</tr>
<tr>
<td>phone</td>
<td><?=$match['original_phone']?></td>
<td><?=$match['matched_phone']?></td>
</tr>
<tr>
<td>gst_number</td>
<td><?=$match['original_gst_number']?></td>
<td><?=$match['matched_gst_number']?></td>
</tr>
<tr>
<td>sales_person</td>
<td><?=$match['original_sales_person']?></td>
<td><?=$match['matched_sales_person']?></td>
</tr>
<tr>
<td>active_inactive</td>
<td><?=$match['original_active_inactive']?></td>
<td><?=$match['matched_active_inactive']?></td>
</tr>
<tr>
<td>created_at</td>
<td><?=$match['original_created_at']?></td>
<td><?=$match['matched_created_at']?></td>
</tr>
<tr>
<td>updated_at</td>
<td><?=$match['original_updated_at']?></td>
<td><?=$match['matched_updated_at']?></td>
</tr>
<tr>
<td>last_confirmed_at</td>
<td><?=$match['original_last_confirmed_at']?></td>
<td><?=$match['matched_last_confirmed_at']?></td>
</tr>
<tr>
<td>session</td>
<td><?=$match['original_session']?></td>
<td><?=$match['matched_session']?></td>
</tr>
<td><br></td> -->
