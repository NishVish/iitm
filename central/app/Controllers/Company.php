    ...
    public function getDynamicFilters()
    {
        ...
        foreach ($companies as $company) {
            ...
            if (!empty($details['category']))
                $data['selCategory'][$details['category']] = true;
            if (!empty($details['source_notes']))
                $data['selSource'][$details['source_notes']] = true;
            if (!empty($details['state']))
                $data['selState'][$details['state']] = true;
            if (!empty($details['city']))
                $data['selCity'][$details['city']] = true;
            if (!empty($details['last_comments']))
                $data['selComment'][$details['last_comments']] = true;
        }
